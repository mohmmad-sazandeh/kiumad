...
import ModalWrapper from "./coo/CommonModal";
...
const WarehouseModal = ({
  ...
  return (
    <ModalWrapper isOpen={isModalOpen} onClose={onClose} width="w-[350px]">
      ...
      <input
        ...
        className="border rounded-lg px-3 py-2 outline-none focus:ring-2 focus:ring-blue-500 w-full mt-3"
      />
